...
| OUTBOX_CLEANUP_ENABLED                          |           true            | Enables the scheduled cleanup of terminal-state records from the job_execution_status and ongoing_contribution_status outbox tables via the FOLIO Timer API                                                                                                                                                                                                          |
| OUTBOX_CLEANUP_RETENTION_DAYS                   |             7             | Number of days to retain terminal-state records (PROCESSED, FAILED, DE_CONTRIBUTED) before they become eligible for cleanup                                                                                                                                                                                                                                           |
| OUTBOX_CLEANUP_BATCH_SIZE                       |           5000            | Maximum number of records deleted per batch iteration during cleanup                                                                                                                                                                                                                                                                                                  |
