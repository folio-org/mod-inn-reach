...
('5d8e62f8-53b8-4e40-b4cd-3cdb36721f7b', 'pickupLocCode1', 'displayName1', 'deliveryStop1');
...
central_item_type, need_before, title, author, folio_patron_id, folio_item_id, folio_request_id, folio_loan_id, folio_item_barcode,
...
('d62d667c-d693-4423-bdff-3c69f9518cf7', extract(epoch from current_timestamp), '5d8e62f8-53b8-4e40-b4cd-3cdb36721f7b',
 ...
 'ea11eba7-3c0f-4d15-9cca-c8608cd6bc8a', 'fd5109c7-8934-4294-9504-c1a4a4f07c96', '1111111',  1, 'patronName1');

INSERT INTO transaction_patron_hold (id, call_number, shipped_item_barcode) VALUES
('d62d667c-d693-4423-bdff-3c69f9518cf7', '0123456789', '1111111');
