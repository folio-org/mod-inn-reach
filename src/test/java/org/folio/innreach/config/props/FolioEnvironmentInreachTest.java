...
import static org.folio.innreach.config.props.FolioEnvironmentInreach.getFolioEnvName;
...
class FolioEnvironmentInreachTest {
  ...
  void shouldThrowExceptionWhenEnvHasDisallowedChars(String env) {
    ...
    var folioEnvironment = FolioEnvironmentInreach.of(env);
