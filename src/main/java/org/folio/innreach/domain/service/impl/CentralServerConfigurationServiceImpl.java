...
public class CentralServerConfigurationServiceImpl implements CentralServerConfigurationService {
  ...
  private <T, U extends InnReachResponseData> T loadRecordPerServer(String uri,
    ...
    log.debug("loadRecordPerServer:: parameters uri: {}, centralServerRecordType: {}, responseToRecordsMapper: {}, centralServerId: {}",
      uri, centralServerRecordType, responseToRecordsMapper, centralServerId);
