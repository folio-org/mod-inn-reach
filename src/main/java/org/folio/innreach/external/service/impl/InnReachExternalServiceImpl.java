...
public class InnReachExternalServiceImpl implements InnReachExternalService {
  ...
  public String postInnReachApi(String centralCode, String innReachRequestUri, Object payload) {
    ...
    log.info("D2IR_CALL client=InnReachClient method=postInnReachApi path={} localCode={} centralCode={} hasBody={}",
      innReachRequestUri, connectionDetails.getLocalCode(), connectionDetails.getCentralCode(), payload != null);
  ...
  public String postInnReachApi(String centralCode, String innReachRequestUri) {
    ...
    log.info("D2IR_CALL client=InnReachClient method=postInnReachApi_noBody path={} localCode={} centralCode={}",
