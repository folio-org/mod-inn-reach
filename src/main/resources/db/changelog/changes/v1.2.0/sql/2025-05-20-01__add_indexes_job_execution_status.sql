-- A.1: Partial composite index for the scheduler "claim" query.
...
-- A.2: Partial index on contribution(job_id) for active contributions only.
...
-- A.3: Partial index for the getInProgressRecordsCount() query.
